...
class BookControllerTest {
    ...
    void shouldGetBooksByAuthor() throws Exception {
        // Given
        List<BookResponse> books = Arrays.asList(bookResponse);
        when(bookSearchService.getBooksByAuthor("Test Author")).thenReturn(books);
    ...
    void shouldGetBooksByTitle() throws Exception {
        // Given
        List<BookResponse> books = Arrays.asList(bookResponse);
        when(bookSearchService.getBooksByTitle("Test Book")).thenReturn(books);
    ...
    void shouldGetBooksByCategory() throws Exception {
        // Given
        List<BookResponse> books = Arrays.asList(bookResponse);
        when(bookSearchService.getBooksByCategory(BookCategory.FICTION)).thenReturn(books);
    ...
    void shouldGetBooksWithStock() throws Exception {
        // Given
        List<BookResponse> books = Arrays.asList(bookResponse);
        when(bookSearchService.getBooksWithStock()).thenReturn(books);
    ...
    void shouldGetBooksOutOfStock() throws Exception {
        // Given
        List<BookResponse> books = Arrays.asList(bookResponse);
        when(bookSearchService.getBooksOutOfStock()).thenReturn(books);
    ...
    void shouldSearchBooksByText() throws Exception {
        // Given
        List<BookResponse> books = Arrays.asList(bookResponse);
        when(bookSearchService.searchBooks("test")).thenReturn(books);
